...
# plot_influence_paths(G,the_pos2,O_hat,id_groups,round(0.01*N),letters = T)
...
plots_names <- c(NA,
                 ...
                 "Asortativity",
                 "Mean Distance",
                 NA,"Degree Standard Deviation",
                 "Clustering Modularity")
pdf(paste0(path_code,"GOF.pdf"),height = 5,width = 8)
